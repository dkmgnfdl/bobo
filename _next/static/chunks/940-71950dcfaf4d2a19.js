      ...
      function d(e) {
        ...
        function y(e) {
          u &&
            ...
            (u.wrapperEl.removeEventListener("transitionend", y), !c && P());
        }
        let S = () => {
          ...
          L = () => {
            if (u.destroyed || !u.autoplay.running) return;
            let e = (0, s.g)();
            "hidden" === e.visibilityState && ((p = !0), M(!0)),
              "visible" === e.visibilityState && P();
          },
          k = (e) => {
            "mouse" === e.pointerType &&
              ((p = !0), (c = !0), u.animating || u.autoplay.paused || M(!0));
          },
          O = (e) => {
        ...
        f("init", () => {
          ...
          f("beforeTransitionStart", (e, t, i) => {
            !u.destroyed &&
              u.autoplay.running &&
              (i || !u.params.autoplay.disableOnInteraction ? M(!0, !0) : C());
          }),
          f("sliderFirstMove", () => {
          ...
          Object.assign(u.autoplay, { start: x, stop: C, pause: M, resume: P });
      }
    },
    3987: function (e, t, i) {
      "use strict";
    ...
    7702: function (e, t, i) {
      ...
      class O {
        constructor() {
          ...
          (c.__swiper__ = !0),
            (c.support = d()),
            (c.device = p({ userAgent: t.userAgent })),
            (c.browser =
              (a ||
                (a = (function () {
                  let e = (0, n.a)(),
      ...
      function I(e, t) {
        ...
        Object.keys(t)
          ...
          .forEach((i) => {
            void 0 === e[i]
              ? (e[i] = t[i])
              : _(t[i]) && _(e[i]) && Object.keys(t[i]).length > 0
              ? t[i].__swiper__
                ? (e[i] = t[i])
                : I(e[i], t[i])
              : (e[i] = t[i]);
        ...
        R = (0, l.forwardRef)(function (e, t) {
          ...
          return (
            ...
            V(() => {
              ...
              })(L, y.current, R, S.current, (e) => e.key);
              return (
                (y.current = L),
                (S.current = R),
                e.length &&
                  ...
                  (function (e) {
                    ...
                    u.includes("loop") &&
                      ...
                      u.includes("children") && p && T && w.virtual.enabled
                        ? ((T.slides = p), T.update(!0))
                        : u.includes("virtual") &&
                          T &&
                          w.virtual.enabled &&
                          (p && (T.slides = p), T.update(!0)),
